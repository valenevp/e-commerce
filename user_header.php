...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="about.php" class="logo">Air Drop<img src="./fotos/logo3.png" width="50px" height="50px"><span></span></a>
      ...
      <div class="profile">
         ...
         <div class="flex-btn">
            <a href="user_register.php" class="option-btn">Registo</a>
         ...
         ?>
         <p>Por favor entrar ou registo!</p>
         <div class="flex-btn">
            <a href="user_register.php" class="option-btn">Registo</a>
            <a href="user_login.php" class="option-btn">Entrar</a>
         </div>
